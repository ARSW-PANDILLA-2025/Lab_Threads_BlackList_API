...
public class Test3SpecificIPsTest {
    ...
    @BeforeEach
    void setUp() {
        // Usamos el facade real que trae las IPs del laboratorio
        facade = HostBlackListsDataSourceFacade.getInstance();

        // Configuramos las políticas con el umbral esperado
        Policies policies = new Policies();
        policies.setAlarmCount(BLACK_LIST_ALARM_COUNT);

        // Inicializamos el checker con facade y policies
    ...
    void test3_8_comprehensivePerformanceAnalysisWithLogging() {
        ...
        for (int threads : threadCounts) {
            System.out.println("==================== TESTS WITH " + threads + " THREADS ====================");
            System.out.println();
